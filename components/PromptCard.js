    ...
    return (
        <div className='prompt_card'>
            <div className="flex justify-between items-start gap-5">
                <div className='flex-1 flex justify-start items-center gap-3 cursor-pointer' onClick={()=>{goToUserProfile(post.creator._id)}}>
                ...
                <div className='copy_btn' onClick={handleCopy}>
                    <Image src={copied ? '/assets/icons/tick.svg' : '/assets/icons/copy.svg'} alt='copy_image' width={12} height={12} />
                </div>
            </div>
